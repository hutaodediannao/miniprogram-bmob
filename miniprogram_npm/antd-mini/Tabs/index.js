...
var Tabs = function (props) {
    ...
    var _d = useInstanceBoundingClientRect(), getBoundingClientRectWithBuilder = _d.getBoundingClientRectWithBuilder,
        getBoundingClientRect = _d.getBoundingClientRect;
    var updateFade = useStableCallback(function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                            getBoundingClientRectWithBuilder(function (id) {
                                return "#ant-tabs-bar-scroll-view".concat(id);
                            }),
                            getBoundingClientRectWithBuilder(function (id) {
                                return "#ant-tabs-bar-item".concat(id, "-").concat(props.items.length - 1);
                            }),
                        ])];
                    case 1:
    ...
    var updateScroll = useStableCallback(function () {
        return __awaiter(void 0, void 0, void 0, function () {
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([
                            ...
                            getBoundingClientRectWithBuilder(function (id) {
                                return "#ant-tabs-bar-item".concat(id, "-").concat(current);
                            }),
                        ])];
                    case 1:
                        _a = _b.sent(), view = _a[0], item = _a[1];
    ...
    return __assign({
        scrollHeight: scrollHeight, mixin: {
            value: currentValue,
        }
    }, state);
};
